...
void test_mul(void){
    ...
    TEST_ASSERT_EQUAL(SUCCESS, complex_multiply(&c1, &c2, &result));
    TEST_ASSERT_EQUAL(0, result.real);
    TEST_ASSERT_EQUAL(0, result.imaginary);
...
void test_div(void){
    ...
    TEST_ASSERT_EQUAL(ERROR_DIV_BY_ZERO, complex_divide(&c1, &c2, &result));
    ...
    TEST_ASSERT_EQUAL(SUCCESS, complex_divide(&c1, &c2, &result));
